...
const baseSentences: Record<string, Sentence> = {
  ...
  s1_01_1: {
    ...
    pronunciationEn: 'hai, ɔːl gʊd?',
    pronunciationZh: 'hāi, yī qiè dōu hǎo ma?',
    tags: ['인사', '수업'],
    difficulty: 1,
  },
  s1_01_2: {
    ...
    pronunciationEn: 'jɛs, ɔːl gʊd',
    pronunciationZh: 'shì de, yī qiè dōu hǎo',
    tags: ['인사', '수업'],
    difficulty: 1,
  },
  s1_01_3: {
    ...
    pronunciationEn: 'θæŋk juː',
    pronunciationZh: 'xiè xie',
    tags: ['인사', '기본'],
    difficulty: 1,
  },
  ...
  s1_02_1: {
    ...
    pronunciationEn: 'rɪˈlæks jɔːr feɪs',
    pronunciationZh: 'fàng sōng nǐ de liǎn',
    tags: ['수업', '자세', '얼굴'],
    difficulty: 1,
  },
  s1_02_2: {
    ...
    pronunciationEn: 'lʊk miː ɪn ðə aɪz',
    pronunciationZh: 'kàn zhe wǒ de yǎn jīng',
    tags: ['수업', '시선'],
    difficulty: 1,
  },
  s1_02_3: {
    ...
    pronunciationEn: 'lʊk əˈhɛd',
    pronunciationZh: 'kàn qián fāng',
    tags: ['수업', '시선'],
    difficulty: 1,
  },
  ...
  s1_03_1: {
    ...
    pronunciationEn: 'ˈloʊər jɔːr ˈʃoʊldərz',
    pronunciationZh: 'fàng xià jiān bǎng',
    tags: ['수업', '자세', '어깨'],
    difficulty: 1,
  },
  s1_03_2: {
    ...
    pronunciationEn: 'rɪˈlæks jɔːr nɛk',
    pronunciationZh: 'fàng sōng nǐ de bó zi',
    tags: ['수업', '자세', '목'],
    difficulty: 1,
  },
  s1_03_3: {
    ...
    pronunciationEn: 'doʊnt gɛt stɪf',
    pronunciationZh: 'bú yào jiāng yìng',
    tags: ['수업', '자세'],
    difficulty: 2,
  },
  ...
  s1_04_1: {
    ...
    pronunciationEn: 'doʊnt juːz fɔːrs ɪn jɔːr ɑːrmz',
    pronunciationZh: 'shǒu bì bú yào yòng lì',
    tags: ['수업', '팔', '연결'],
    difficulty: 2,
  },
  s1_04_2: {
    ...
    pronunciationEn: 'fiːl jɔːr ˈpɑːrtnərz hænd',
    pronunciationZh: 'gǎn shòu nǐ dā dàng de shǒu',
    tags: ['수업', '손', '연결'],
    difficulty: 2,
  },
  s1_04_3: {
    ...
    pronunciationEn: 'ˈsɔːftər',
    pronunciationZh: 'gèng qīng róu yī xiē',
    tags: ['수업', '피드백'],
    difficulty: 1,
  },
  ...
  s1_05_1: {
    ...
    pronunciationEn: 'briːð ˈdiːpli',
    pronunciationZh: 'shēn hū xī',
    tags: ['수업', '호흡'],
    difficulty: 1,
  },
  s1_05_2: {
    ...
    pronunciationEn: 'doʊnt rʌʃ',
    pronunciationZh: 'bú yào zháo jí',
    tags: ['수업', '이완'],
    difficulty: 1,
  },
  s1_05_3: {
    ...
    pronunciationEn: 'kɑːm, ˈsloʊli',
    pronunciationZh: 'fàng sōng, màn man lái',
    tags: ['수업', '이완', '정서'],
    difficulty: 1,
  },
  ...
  s1_06_1: {
    ...
    pronunciationEn: 'faɪnd jɔːr ˈæksɪs',
    pronunciationZh: 'zhǎo dào nǐ de zhóu xīn',
    tags: ['수업', '축', '중심'],
    difficulty: 2,
  },
  s1_06_2: {
    ...
    pronunciationEn: 'kʌm bæk tuː ˈsɛntər',
    pronunciationZh: 'huí dào zhōng xīn',
    tags: ['수업', '중심'],
    difficulty: 2,
  },
  s1_06_3: {
    ...
    pronunciationEn: 'doʊnt liːn bæk',
    pronunciationZh: 'bú yào wǎng hòu dǎo',
    tags: ['수업', '축', '교정'],
    difficulty: 2,
  },
  ...
  s1_07_1: {
    ...
    pronunciationEn: 'ʃɪft jɔːr weɪt',
    pronunciationZh: 'zhuǎn yí zhòng xīn',
    tags: ['수업', '체중'],
    difficulty: 1,
  },
  s1_07_2: {
    ...
    pronunciationEn: 'ˈtrænsfɜːr ðə weɪt ˈfʊli',
    pronunciationZh: 'wán quán zhuǎn yí zhòng xīn',
    tags: ['수업', '체중'],
    difficulty: 2,
  },
  s1_07_3: {
    ...
    pronunciationEn: 'weɪt',
    pronunciationZh: 'děng yī xià',
    tags: ['수업', '타이밍'],
    difficulty: 1,
  },
  ...
  s1_08_1: {
    ...
    pronunciationEn: 'ˈoʊpən jɔːr ɑːrmz',
    pronunciationZh: 'zhāng kāi shuāng bì',
    tags: ['수업', '아브라소'],
    difficulty: 1,
  },
  s1_08_2: {
    ...
    pronunciationEn: 'kloʊz ðə ɪmˈbreɪs',
    pronunciationZh: 'hé shàng yōng bào',
    tags: ['수업', '아브라소'],
    difficulty: 2,
  },
  s1_08_3: {
    ...
    pronunciationEn: 'doʊnt pʊʃ',
    pronunciationZh: 'bú yào tuī',
    tags: ['수업', '아브라소', '교정'],
    difficulty: 1,
  },
  ...
  s1_09_1: {
    ...
    pronunciationEn: 'fiːl ðə kəˈnɛkʃən',
    pronunciationZh: 'gǎn shòu lián jiē',
    tags: ['수업', '연결'],
    difficulty: 2,
  },
  s1_09_2: {
    ...
    pronunciationEn: 'steɪ wɪð miː',
    pronunciationZh: 'liú zài wǒ shēn biān',
    tags: ['수업', '연결', '정서'],
    difficulty: 2,
  },
  s1_09_3: {
    ...
    pronunciationEn: 'doʊnt goʊ ɑːn jɔːr oʊn',
    pronunciationZh: 'bú yào yī gè rén zǒu',
    tags: ['수업', '연결', '교정'],
    difficulty: 2,
  },
  ...
  s1_10_1: {
    ...
    pronunciationEn: 'əˈgɛn',
    pronunciationZh: 'zài lái yī cì',
    tags: ['수업', '피드백'],
    difficulty: 1,
  },
  s1_10_2: {
    ...
    pronunciationEn: 'naʊ jɛs',
    pronunciationZh: 'xiàn zài duì le',
    tags: ['수업', '피드백'],
    difficulty: 1,
  },
  s1_10_3: {
    ...
    pronunciationEn: 'ˈbɛtər laɪk ðɪs',
    pronunciationZh: 'zhè yàng gèng hǎo',
    tags: ['수업', '피드백'],
    difficulty: 1,
  },
